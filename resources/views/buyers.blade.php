    ...
    <main>
        <div class="max-w-5xl w-full mx-auto py-10 px-5">
            ...
            <x-table :columns=$columns>
                <tr class="flex p-5">
                    <td class="flex-[2] {{$column_class}}">Pedro</td>
                    <td class="flex-[2] {{$column_class}}">47 9 9196-6719</td>
                    <td class="flex-[1] {{$column_class}}">
                        <a href="{{route('buyers.update', ['id' => 1])}}" class="group p-3 rounded-[999px] flex justify-center items-center hover:bg-blue-400/25">
                        ...
                        <a href="{{route('buyers.delete', ['id' => 1])}}" class="group p-3 rounded-[999px] flex justify-center items-center hover:bg-red-400/25">
