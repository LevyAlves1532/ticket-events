                ...
                <tbody>
                    <tr class="flex p-5">
                        ...
                        <td class="flex-1 {{$column_class}}">
                            <a href="{{route('events.update', ['id' => '10'])}}" class="group p-3 rounded-[999px] flex justify-center items-center hover:bg-blue-400/25">
                            ...
                            <a href="{{route('events.delete', ['id' => '10'])}}" class="group p-3 rounded-[999px] flex justify-center items-center hover:bg-red-400/25">
